...
exports.select = function(obj, callback){
	...
	function complete(sql){
		//是否首先读取从库
		var slave = config.system.master_only ? false : true;
		return callback(null,{
			db: partition.get_db_conf(obj._table, slave),
			table: obj._table,
			sql: sql
		});
	}
